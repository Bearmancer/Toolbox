# Review package: 9c677c9..1cdc80b
...
## Files changed
 checks/Program.cs | 14 +++++++++++++-
 task-16-report.md | 53 ++++++++++++++++++++++++++++++++++++++++-------------
 2 files changed, 53 insertions(+), 14 deletions(-)

## Diff
diff --git a/checks/Program.cs b/checks/Program.cs
index 13027ab..850a1e1 100644
--- a/checks/Program.cs
+++ b/checks/Program.cs
@@ -8,21 +8,26 @@ if (args.Length > 0 && args[0] == "--stub")
...
@@ -116,20 +121,27 @@ async Task ChildStubIgnoreTerminationAsync()
...
@@ -108,14 +125,24 @@ Build succeeded. 0 Warning(s) 0 Error(s)
